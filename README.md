...
https://github.com/coding-to-music/cards-images-maps-mern

https://cards-images-maps-mern.herokuapp.com

by Anton Karytski https://github.com/heyheyjude

https://github.com/heyheyjude/travel-app
...
git branch -M main
git remote add origin git@github.com:coding-to-music/cards-images-maps-mern.git
...
```java
heroku create cards-images-maps-mern
```
...
heroku config:set MONGODB_URI="mongodb+srv://<userid>:<password>@cluster0.zadqe.mongodb.net/cards-images-maps-mern?retryWrites=true&w=majority"
heroku config:set PASSWORD="something-secret"

heroku config:set PUBLIC_URL="https://cards-images-maps-mern.herokuapp.com"
```
...
```java
=== cards-images-maps-mern Buildpack URL
heroku/nodejs
```
...
```java
Buildpack added. Next release on cards-images-maps-mern will use:
  1. heroku/nodejs
...
```java
Upgrading /mnt/volume_nyc1_01/cards-images-maps-mern/package.json
[====================] 15/15 100%
...
```java
Upgrading /mnt/volume_nyc1_01/cards-images-maps-mern/client/package.json
[====================] 18/18 100%
